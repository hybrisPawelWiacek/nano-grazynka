...
CREATE TABLE "VoiceNote" (
    ...
    CONSTRAINT "VoiceNote_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE "ProjectNote" (
    ...
    CONSTRAINT "ProjectNote_voiceNoteId_fkey" FOREIGN KEY ("voiceNoteId") REFERENCES "VoiceNote" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE "EntityUsage" (
    ...
    "correctedText" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "EntityUsage_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "EntityUsage_voiceNoteId_fkey" FOREIGN KEY ("voiceNoteId") REFERENCES "VoiceNote" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
-- CreateIndex
CREATE INDEX "VoiceNote_projectId_idx" ON "VoiceNote"("projectId");
...
-- CreateIndex
CREATE INDEX "EntityUsage_entityId_idx" ON "EntityUsage"("entityId");

-- CreateIndex
CREATE INDEX "EntityUsage_voiceNoteId_idx" ON "EntityUsage"("voiceNoteId");
